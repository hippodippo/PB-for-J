...
7.) To use PB for J to create a new post file, type "ruby pbforj.rb" (without the parentheses). PB for J will execute and prompt you for the: Name of the file (pb-for-j), Title of your new post (PB for J is awesome!), and the extension of your file (eg. markdown, html, etc.), just leave blank if you use markdown. <br />
<br />
